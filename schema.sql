...
CREATE TABLE `Restaurants` (
  ...
  `dish_name1` VARCHAR(500) NULL DEFAULT NULL,
  `dish_image1` VARCHAR(500) NULL DEFAULT NULL,
  `dish_name2` VARCHAR(500) NULL DEFAULT NULL,
  `dish_image2` VARCHAR(500) NULL DEFAULT NULL,
  `dish_name3` VARCHAR(500) NULL DEFAULT NULL,
  `dish_image3` VARCHAR(500) NULL DEFAULT NULL,
  `tip` VARCHAR(500) NULL DEFAULT NULL,
  `features` VARCHAR(500) NULL DEFAULT NULL,
